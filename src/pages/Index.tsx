        ...
        <div className="container mx-auto px-6 md:px-8">
          ...
          <div className="grid gap-6 max-w-4xl mx-auto">
            {products.map((product, i) => (
              <article
                key={product.title}
                className="group relative flex flex-col sm:flex-row items-stretch gap-6 rounded-[1.75rem] bg-card border border-border/60 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-1 animate-float-up"
